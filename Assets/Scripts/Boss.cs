...
public class Boss : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Estadisticas fase 1
        phases[0] = new BossStats(15, 5.0f, 10.0f, 2.0f, 4.5f, true);

        //Estadisticas fase 2
        phases[1] = new BossStats(3, 25.0f, 30.0f, 1.0f, 3.9f, false);

        //Estadisticas fase 3
        phases[2] = new BossStats(10, 10.0f, 15.0f, 3.0f, 1.0f, true);
